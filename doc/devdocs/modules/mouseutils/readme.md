...
Mouse Utilities is a collection of tools designed to enhance mouse and cursor functionality on Windows. The module contains six sub-utilities that provide different mouse-related features.
