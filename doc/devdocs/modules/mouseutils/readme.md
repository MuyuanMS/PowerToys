...
Mouse Utilities is a collection of tools designed to enhance mouse and cursor functionality on Windows. The module contains seven sub-utilities that provide different mouse-related features.
...
- **Auto Hide Cursor**: Hides the pointer after it remains stationary for the configured delay
- **Cursor Wrap**: Lets the pointer wrap between opposite edges of the desktop
