...
The shared [`Monaco.props`](/src/Monaco.props) file downloads the Monaco editor source code when [`/src/Monaco/monacoSRC`] does not exist, then adds the generated files to projects that import the props file.
