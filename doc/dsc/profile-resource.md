...
| Function       | `F1`–`F24`                                                                                                                                                                                                                                                                                                                   |
| Modifiers      | `Ctrl`, `Alt`, `Shift`, `Win` (either side, valid in shortcuts and targets); `LCtrl`, `RCtrl`, `LAlt`, `RAlt`, `LShift`, `RShift`, `LWin`, `RWin` (required for single-key `from` values)                                                                                                                                       |
