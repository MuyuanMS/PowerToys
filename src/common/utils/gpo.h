...
namespace powertoys_gpo
{
    ...
    const std::wstring POLICY_CONFIGURE_ENABLED_CLIP_PING = L"ConfigureEnabledUtilityClipPing";
...
#pragma region UtilityEnabledStatePolicies
    ...
    {
        return getUtilityEnabledValue(POLICY_CONFIGURE_ENABLED_CLIP_PING);
    }
