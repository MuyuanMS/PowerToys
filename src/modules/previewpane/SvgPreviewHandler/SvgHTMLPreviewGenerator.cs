...
namespace SvgPreviewHandler
{
    ...
    {
        internal readonly record struct SettingsSnapshot(int ColorMode, Color SolidColor, Color ThemeColor, int CheckeredShade);
        ...
        public string GeneratePreview(string svgData, SettingsSnapshot settings)
        {
            ...
            return colorMode switch
            {
                ...
                SvgPreviewColorMode.Checkered => string.Format(CultureInfo.InvariantCulture, HtmlTemplateCheckeredCompositeFormat, GetConfiguredCheckeredShadeImage(settings.CheckeredShade), svgData),
        ...
        private static string GetConfiguredCheckeredShadeImage(int configuredShade)
        {
            var checkeredShade = (SvgPreviewCheckeredShade)configuredShade;
