...
public class NodeRuntimeLocatorTests
{
    ...
    [DataRow("22.0.0", ">=22.0.0+foo..bar", false)]
    [DataRow("22.0.0", ">=022.0.0", false)]
    [DataRow("22.0.0", ">=22.0.0-01", false)]
    ...
    [TestMethod]
    [DataRow("v24.0.0-rc.1", ">=24.0.0-rc.1", true)]
    [DataRow("v24.0.0-rc.2", ">=24.0.0-rc.1", true)]
