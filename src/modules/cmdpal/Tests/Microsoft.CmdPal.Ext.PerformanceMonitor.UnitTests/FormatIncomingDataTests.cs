...
public class FormatIncomingDataTests
{
    ...
    [DataTestMethod]
    [DataRow("0.0 Kbps", "0.0  Kbps")]
    [DataRow("50.0 Kbps", "50.0 Kbps")]
    [DataRow("100 Kbps", "100  Kbps")]
    [DataRow("???", "???")]
    public void AsBandTitle_PadsOnlyTheNumericField(string formattedSpeed, string expected)
    {
        Assert.AreEqual(expected, FormatIncomingData.AsBandTitle(formattedSpeed));
    }
}
