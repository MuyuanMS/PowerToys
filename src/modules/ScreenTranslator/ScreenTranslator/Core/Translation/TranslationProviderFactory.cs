    ...
    public static ITranslationProvider Create(ScreenTranslatorSettings? settings)
    {
        ...
        switch (providerType)
        {
            case "AzureTranslator":
                ...
                return new AzureTranslatorProvider(azureEndpoint, azureRegion, azureApiKey, cloudConsentEnabled: true);
            ...
            case "LibreTranslate":
                ...
                return new LibreTranslateProvider(libreEndpoint, libreApiKey, cloudConsentEnabled: true);
